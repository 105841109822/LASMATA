...
import { FileText, Calendar, ArrowUpDown, Search } from "lucide-react";
...
export function ReportsManagementContent() {
            ...
            <div className="space-y-6 mt-4">
              <div className="grid grid-cols-2 gap-6 p-4 bg-muted/30 rounded-lg">
                ...
                <div>
                  ...
                  <div className="mt-1">
                    {getStatusBadge(mapStatus(selectedReport.status))}
                  </div>
                </div>
              </div>
