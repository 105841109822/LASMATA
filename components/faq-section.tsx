...
const faqs = [
  {
    question: "Apa itu LASMATA?",
    answer:
      "LASMATA (Layanan ASpirasi MAsyarakat TembalAe.) adalah platform digital yang memungkinkan masyarakat Desa Karang Baru Timur untuk menyampaikan aspirasi, keluhan, dan saran terkait pembangunan dan pelayanan publik secara transparan dan terorganisir.",
  },
  {
    question: "Siapa yang bisa menggunakan layanan ini?",
    answer:
      "Seluruh warga Desa tembalae yang memiliki NIK (Nomor Induk Kependudukan) dapat menggunakan layanan ini. Data NIK hanya digunakan untuk verifikasi dan dijamin keamanannya.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Tidak, layanan LASMATA sepenuhnya gratis dan dapat diakses oleh seluruh warga Desa Tembalae tanpa dipungut biaya apapun.",
  },
];
