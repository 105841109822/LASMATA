...
const socialMedia = [
  ...
  {
    icon: Mail,
    href: "mailto:info@desakita.desa.id",
    label: "Email",
  },
];
      ...
      <div className="container mx-auto px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-primary">LASMATA</h3>
            <p className="text-sm text-muted-foreground">
              Layanan Aspirasi Desa Tembalae untuk mewujudkan desa yang lebih
              transparan, demokratis, dan sejahtera.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2 text-sm text-muted-foreground">
                ...
                <span>Desa Tembalae, Kec. Pajo, Kabupaten Dompu, NTB</span>
              </li>
              ...
              <li className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <span>info@desatembalae.desa.id</span>
              </li>
            </ul>
