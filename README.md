...
LASMATA dibangun dengan Next.js App Router dan alur server action agar proses pengajuan aspirasi, validasi NIK, penyimpanan laporan, dan manajemen admin berjalan dalam satu sistem yang terpadu. Aplikasi ini memisahkan pengalaman pengguna publik dan admin, tetapi keduanya memakai sumber data yang sama di PostgreSQL melalui Prisma.
